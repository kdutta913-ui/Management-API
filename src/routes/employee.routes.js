...
router.post("/", validateEmployeeCreate,validateEmployeeFields,validateName,validateEmail,validatePhone,validateSalary, createEmployee) //create employee
router.get("/", getEmployees) //get all the employees
router.get("/:id", getEmployeeById) // get the employee by id
router.patch("/:id",validateEmployeeFields, validateName, validateEmail, validatePhone, validateSalary, updateEmployee) // update something of the employee by id
